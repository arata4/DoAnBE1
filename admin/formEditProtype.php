...
if(isset($_GET['Type_id'])){
    $id=$_GET['Type_id'];
    $getAllTypeFormId=$protype->getAllTypeFormId($id);
}
if(isset($_POST['name'])){
    $name=$_POST['name'];
    $protype->updateProtype($name,$id);
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <!-- BEGIN USER FORM -->
                            <?php foreach($getAllTypeFormId as $value){?>
                            <form action="formEditProtype.php?Type_id=<?= $value['Type_id']?>" method="post" class="form-horizontal"
                                enctype="multipart/form-data">
                                <div class="control-group">
                                    <label class="control-label">Name :</label>
                                    <div class="controls">
                                        <input type="text" class="span11" placeholder="Protype name" name="name" value="<?=$value['Type_name']?>" /> *
                                    </div>
                                </div>
