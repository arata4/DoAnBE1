            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-title"> <span class="icon"><a href="formAddManufacture.php"> <i class="icon-plus"></i>
                                </a></span>
                            <h5>Manufacture</h5>
                        </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <a href="formEditManu.php?Manu_id=<?=$value['Manu_id']?>" class="btn btn-success btn-mini">Edit</a>          
                                            <a href="delete.php?Manu_id=<?=$value['Manu_id']?>" class="btn btn-danger btn-mini">Delete</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
