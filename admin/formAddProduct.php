...
if (isset($_POST['name'])){
    ...
    if($uploadOk == 1){
        ...
        $check=$product->insertProduct($name,$manu_id,$type_id,$price,$pro_img,$description,$feature);
        if ($check) {
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <form action="formAddProduct.php" method="post" class="form-horizontal"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span11" placeholder="price" name="price" require /> *
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Feature :</label>
                                            <div class="controls">
                                                <input type="number" class="span11" name="feature" min="0" max="1" require /> *
                                            </div>
                                        </div>
