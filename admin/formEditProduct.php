...
$getManu=$manu->getAllManu();
$product=new Product;
if(isset($_GET['id'])){
    $id=$_GET['id'];
    $getProductID=$product->getProductID($id);
}
...
if (isset($_POST['name'])){
    ...
    if ($uploadOk == 0) {
        ...
        $pro_img=$_FILES['fileUpload']['name'];
        $description=$_POST['description'];
        $price=$_POST['price'];
        $feature=$_POST['feature'];
        $check=$product->updateProduct($name,$manu_id,$type_id,$price,$pro_img,$description,$feature,$id);
        if ($check) {
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <form action="formEditProduct.php?id=<?=$value['id']?>" method="post" class="form-horizontal"
                                enctype="multipart/form-data">
                                <div class="control-group">
                                    <label class="control-label">Name :</label>
                                    <div class="controls">
                                        <input type="text" class="span11" placeholder="Product name" name="name" value="<?=$value['Name'] ?>" /> *
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <option required value="<?php echo $value['Manu_id'] ?>"><?php echo $value['Manu_name'] ?> </option>
                                        <?php foreach ($getManu as $valueManu) { ?>
                                                <option required value="<?php echo $valueManu['Manu_id'] ?>"><?php echo $valueManu['Manu_name'] ?> </option>
                                            <?php } ?>
                                        </select> *
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <option require value="<?= $value['Type_id'] ?>"><?= $value['Type_name'] ?></option>
                                        <?php
                                        foreach ($getProtype as $valueType){?>
                                            <option require value="<?= $valueType['Type_id'] ?>"><?= $valueType['Type_name'] ?></option>
                                        <?php }?>                                             
                                        </select> *
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Choose an image :</label>
                                        <td><img src="../public/images/<?=$value['Pro_image']?>" alt=""></td>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span11" placeholder="price" name="price" value="<?=$value['Price']?>" require /> *
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Feature :</label>
                                            <div class="controls">
                                                <input type="number" class="span11" name="feature" min="0" max="1" value="<?=$value['Feature']?>" require /> *
                                            </div>
                                        </div>
