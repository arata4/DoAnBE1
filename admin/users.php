            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-title"> <span class="icon"><a href="formAddUser.php"> <i class="icon-plus"></i>
                                </a></span>
                            <h5>Products</h5>
                        </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        <td><?=$value['id']?></td>
                                        <td><?=$value['user']?></td>
                                        <td><?=str_ireplace($value['pass'],"***********",$value['pass'])?></td>
                                        <td>
                                            <a href="formEditUser.php?id=<?=$value['id']?>" class="btn btn-success btn-mini">Edit</a>
