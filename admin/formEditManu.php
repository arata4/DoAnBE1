...
if(isset($_GET['Manu_id'])){
    $id=$_GET['Manu_id'];
    $getAllManuFormId=$manu->getAllManuFormId($id);
}
if(isset($_POST['name'])){
    $name=$_POST['name'];
    $manu->updateManufacture($name,$id);
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <!-- BEGIN USER FORM -->
                            <?php foreach($getAllManuFormId as $value){?>
                            <form action="formEditManu.php?Manu_id=<?= $value['Manu_id']?>" method="post" class="form-horizontal"
                                enctype="multipart/form-data">
                                <div class="control-group">
                                    <label class="control-label">Name :</label>
                                    <div class="controls">
                                        <input type="text" class="span11" placeholder="Manu name" name="name" value="<?=$value['Manu_name']?>" /> *
                                    </div>
                                </div>
