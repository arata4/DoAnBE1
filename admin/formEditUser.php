...
if(isset($_GET['id'])){
    $id=$_GET['id'];
    $getUserFromID=$user->getUserFromID($id);
}
if(isset($_POST['user'])){
    $name=$_POST['user'];
    $role=$_POST['role'];
    $user->editUser($name,$role,$id);
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <!-- BEGIN USER FORM -->
                            <?php foreach($getUserFromID as $value){?>
                            <form action="formEditUser.php?id=<?= $value['id']?>" method="post" class="form-horizontal"
                                enctype="multipart/form-data">
                                <div class="control-group">
                                    <label class="control-label">User :</label>
                                    <div class="controls">
                                        <input type="text" class="span11" placeholder="User" name="user" value="<?=$value['user']?>" /> *
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Role :</label>
                                    <div class="controls">
                                        <input type="text" class="span11" placeholder="Role" name="role" value="<?=$value['role']?>" /> *
                                    </div>
                                </div>
